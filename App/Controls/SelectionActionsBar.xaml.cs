...
public enum SelectionAction { Open, OpenContaining, CopyPaths, CopyText, CopyCsv, Properties, ElevatedTerminal, ManageFiles }
...
public partial class SelectionActionsBar : UserControl
{
    ...
    public void SetSelection(ResultSelectionSummary? selection)
    {
        ...
        _open.IsEnabled = _containing.IsEnabled = _paths.IsEnabled =
            _text.IsEnabled = _csv.IsEnabled = _properties.IsEnabled = _terminal.IsEnabled = _manage.IsEnabled = count > 0;
    }
